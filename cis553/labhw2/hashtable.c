...
/*test()
{
  ...
  printf("Calling put(h1, \"one\")... \n");
  if (retVal = put(h1, "one") != 1) {
    printf("\nERROR! put returned %d for \"one\" but should have returned 1\n", retVal);
  }
    exit(0);
  else printf("ok\n");

  printf("Calling put(h1, \"one\")... ");
  if (retVal = put(h1, "one") != 0) {
    printf("\nERROR! put returned %d for \"one\" but should have returned 0\n", retVal);
    exit(0);
  }
  else printf("ok\n");

  printf("Calling put(h2, \"one\")... ");
  if (retVal = put(h2, "one") != 1) {
    printf("\nERROR! put returned %d for \"one\" but should have returned 1\n", retVal);
    exit(0);
  }
  else printf("ok\n");

  printf("Calling get(h1, \"one\")... ");
  if (retVal = get(h1, "one") != 1) {
    printf("\nERROR! get returned %d for \"one\" but should have returned 1\n", retVal);
    exit(0);
  }
  else printf("ok\n");

  printf("Calling put(h1, \"two\")... ");
  if (retVal = put(h1, "two") != 1) {
    printf("\nERROR! put returned %d for \"two\" but should have returned 1\n", retVal);
    exit(0);
  }
  else printf("ok\n");

  printf("Calling get(h1, \"two\")... ");
  if (retVal = get(h1, "two") != 1) {
    printf("\nERROR! get returned %d for \"two\" but should have returned 1\n", retVal);
    exit(0);
  }
  else printf("ok\n");
  ...
  printf("Calling put(h1, \"wot\")... ");
  if (retVal = put(h1, "wot") == 0) {
    printf("\nERROR! put returned %d for \"wot\" but should have returned 1\n", retVal);
    exit(0);
  }
  else printf("ok\n");

  printf("Calling get(h1, \"wot\")... ");
  if (retVal = get(h1, "wot") != 1) {
    printf("\nERROR! get returned %d for \"wot\" but should have returned 1\n", retVal);
    exit(0);
  }
  else printf("ok\n");
